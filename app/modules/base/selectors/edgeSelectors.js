 ...
 * @param {*} parentId
 */
const getItemIds = (state, parentId) => state.getIn([parentId, 'itemIds']) ? state.getIn([parentId, 'itemIds']) : OrderedSet();
 ...
 * @param {*} field
 */
const getItemField = (state, parentId, id, field) => state.getIn([parentId, 'items', id, 'data', field]);
 ...
 * @param {*} parentId
 */
const getSearchParams = (state, parentId) => state.getIn([parentId, 'searchParams']);
