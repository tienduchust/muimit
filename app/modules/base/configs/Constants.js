...
export const DOMAIN_URL = process.env.VERSION === 'internal' ? 'https://servicevala.bkav.com' : 'https://servicevala.hcdt.vn';
...
export const URI_INFO_DEFAULT = process.env.VERSION === 'internal' ? {
...
export const MESSENGER_URI_INFO_DEFAULT = process.env.VERSION === 'internal' ? {
...
export const NOTE_URI_INFO_DEFAULT = process.env.VERSION === 'internal' ? {
    domain: 'servicevala.bkav.com',
    port: '443',
    ssl: true,
} : {
...
export const MQTT_URI_INFO_DEFAULT = process.env.VERSION === 'internal' ? {
...
export const PUSH_URI_INFO_DEFAULT = process.env.VERSION === 'internal' ? {
    domain: 'servicevala.hcdt.vn',
    port: '443',
    ssl: true,
} : {
...
export const UPLOAD_URI_INFO_DEFAULT = process.env.VERSION === 'internal' ? {
...
export default {
    ...
    'quangninh.gov.vn': {
        ...
        COMPANY_NAME_DEFAULT: 'hành chính điện tử - tỉnh quảng ninh',
    ...
    'soctrang.gov.vn': {
        ...
        COMPANY_NAME_DEFAULT: 'hành chính điện tử - tỉnh sóc trăng',
