  ...
  resizeData = (children) =>
    children.map((item, i) => {
      ...
      const props = {
        key: i,
        style: {
          left: this.pointArray[i].x * this.scale,
          top: this.pointArray[i].y * this.scale,
        },
      };
  ...
  render() {
    return (
      ...
      >
        {!this.state.end ? (
          <div key="line">
            <svg className="right-side" viewBox="0,0,300,400">
              <TweenOne
                d="M30,265L30,25"
                component="path"
                animation={[
              ...
              <TweenOne
                component="circle"
                r="20"
                fill={`rgba(${Math.round(Math.random() * 95 + 160)},174,245)`}
                cx="95"
                cy="200"
                animation={{
                  delay: 1300,
